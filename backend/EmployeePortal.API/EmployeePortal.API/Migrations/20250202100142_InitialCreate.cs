            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CompetencyId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    TechnicalSkills = table.Column<float>(type: "real", nullable: false),
                    Communication = table.Column<float>(type: "real", nullable: false),
                    ProblemSolving = table.Column<float>(type: "real", nullable: false),
                    Teamwork = table.Column<float>(type: "real", nullable: false),
                    Leadership = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MetricId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    TaskCompletionRate = table.Column<float>(type: "real", nullable: false),
                    QualityOfWork = table.Column<float>(type: "real", nullable: false),
                    AttendanceRate = table.Column<float>(type: "real", nullable: false),
                    CustomerSatisfaction = table.Column<float>(type: "real", nullable: false),
